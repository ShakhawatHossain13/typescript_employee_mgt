      ...
      <form className={classes.container} >                    
        <div className={classes.wrapper1}>
            ...
            <div className={classes.basicBlock}>  
              ...
              <CustomerAddress  error= {error} setError={setError}  setCustomer={setCustomer} handleFormChange={handleFormChange}/>    
              <CustomerContact  error= {error} setError={setError} setCustomer={setCustomer} handleFormChange={handleFormChange}/>  
            </div>          
        </div>           
        <div className={classes.wrapper2}>
            <CustomerBlackInfo error= {error} setError={setError}  setCustomer={setCustomer} handleFormChange={handleFormChange}/>
            <CustomerSupplimentaryInfo error= {error} setError={setError}  setCustomer={setCustomer} handleFormChange={handleFormChange} />
        </div> 
